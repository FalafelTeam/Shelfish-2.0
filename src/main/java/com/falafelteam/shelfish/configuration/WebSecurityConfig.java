        ...
        http
                .authorizeRequests()
                    .antMatchers("/myProfile")
                        .not().hasRole("Admin")
                    .antMatchers("/addDocument", "/addUser")
                        .hasAnyRole("LibrarianPriv2", "LibrarianPriv3", "Admin")
                    .antMatchers("/modifyDocument/{id}", "/modifyUser/{id}")
                        .hasAnyRole("LibrarianPriv1", "LibrarianPriv2", "LibrarianPriv3", "Admin")
                    .antMatchers("/deleteDocument", "/deleteUser")
